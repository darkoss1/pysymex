...
Usage:
    python -m pysymex.accel.benchmark
    python -m pysymex.accel.benchmark --treewidth 15 --iterations 100
    python -m pysymex.accel.benchmark --compare-all --output results.json
"""
...
def get_system_info() -> SystemInfo:
    ...
    try:
        ...
        numba_version = str(getattr(numba_mod, "__version__", "unknown"))
    except ImportError:
        pass
        ...
        for backend_name, backend_module in backends.items():
            ...
            if result:
                ...
                print(
                    ...
                    f"Â± {result.kernel_time_std_ms:.3f} ms, "
