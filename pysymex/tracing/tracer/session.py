...
from pysymex.tracing.schemas import SystemContextEvent, TracerConfig
from pysymex.tracing.tracer.helpers import TraceWriter, normalise_config_snapshot
...
class TracerSessionMixin:
    ...
    def start_session(
        ...
        Args:
            ...
            config_snapshot: Serialised :class:`~pysymex.execution.config.settings.ExecutionConfig`
        ...
        header = SystemContextEvent(
            ...
            tracer_config=normalise_config_snapshot(raw_config),
        )
