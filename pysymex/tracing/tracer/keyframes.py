...
from pysymex.tracing.schemas import ConstraintEntry, KeyframeEvent, TracerConfig, VerbosityLevel
...
class TracerKeyframeMixin:
    ...
    def _build_keyframe(
        ...
        try:
            ...
            constraint_entries = serialize_constraint_entries(
                self._serializer,
                constraints_raw,
                causality,
