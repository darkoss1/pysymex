...
from pysymex._internal.reporting.formatters.markup import HTMLFormatter, MarkdownFormatter
from pysymex._internal.reporting.formatters.rich.formatter import RichFormatter
...
def format_result(
    ...
    **kwargs: object,
    ...
    if format_type.lower() == "sarif":
        ...
        return SARIFGenerator().generate_execution_result(result).to_json()
