...
from pysymex._internal.reporting.reproduction.args import (
    ReproductionArgsMixin,
)
from pysymex._internal.reporting.reproduction.output import ReproductionOutputMixin
...
class ReproductionGenerator(ReproductionArgsMixin, ReproductionOutputMixin):
    ...
    def generate(
        ...
        if module_context is None:
            logger.warning(
                "Skipping reproduction script for %s; module name unresolved",
                source_file,
            )
            return None
    ...
    def _module_context_for_source(self, source_file: str) -> ReproductionContext | None:
