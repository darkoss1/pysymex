...
from pysymex._internal.sandbox.bridge.codecs import reconstruct_code_obj
from pysymex._internal.sandbox.bridge.payloads import (
...
class ModuleBlob:
    ...
    def get_function_blob(self, function_name: str) -> FunctionBlob:
        ...
        if target is None:
            ...
            msg = f"Function '{function_name}' not found in sandbox module payload"
            raise ValueError(msg)
        payload = {
