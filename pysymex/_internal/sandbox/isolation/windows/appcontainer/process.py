...
if TYPE_CHECKING:
    ...
    from pysymex._internal.sandbox.isolation.windows.native.api import WindowsNativeApi

logger = get_logger(__name__)


class AppContainerProcessMixin:
        ...
        *,
        ...
        try:
            ...
            if wait_result == WAIT_TIMEOUT:
                ...
                msg = f"WaitForSingleObject failed with result {wait_result}"
                raise SandboxSetupError(msg)
...
WindowsNativeProcessMixin = AppContainerProcessMixin
