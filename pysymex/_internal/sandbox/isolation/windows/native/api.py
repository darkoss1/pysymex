...
from .process import NativeProcessCreationMixin
...
from .tokens import NativeTokenMixin


class WindowsNativeApi(
    WindowsNativeProfileMixin,
    NativeTokenMixin,
    NativeProcessCreationMixin,
    ...
    def __init__(self) -> None:
        ...
        if sys.platform != "win32":
            msg = "Windows AppContainer backend requires win32"
