...
from pysymex._internal.tracing.schemas.events import IssueEvent
...
class TracerIssueMixin:
    ...
    def on_issue(
        ...
        Args:
            ...
            issue:    The :class:`~pysymex._internal.analysis.detectors.detector.types.Issue` object.
        ...
        if issue_model is not None:
            z3_model = TraceSerialization.model_excerpt(
                self._serializer,
                issue_model,
                max_vars=30,
        ...
        try:
            ...
            issue_constraints: list[object] = cast(
                "list[object]",
                getattr(issue, "constraints", None) or [],
            )
            constraints_at_issue = TraceSerialization.constraint_entries(
                self._serializer,
                issue_constraints,
                causality_base,
