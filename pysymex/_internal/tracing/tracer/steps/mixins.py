...
from pysymex._internal.tracing.schemas.events import StepDeltaEvent
from pysymex._internal.tracing.schemas.primitives import ConstraintEntry, StackDiff, VarDiff
from pysymex._internal.tracing.tracer.serialization import TraceSerialization
from pysymex._internal.tracing.tracer.steps.source import instruction_source_line
...
class TracerStepMixin:
    ...
    def post_step(
        ...
        """Emit a :class:`~pysymex._internal.tracing.schemas.StepDeltaEvent` after dispatch.
        ...
        step_latency_ms = TraceSerialization.elapsed_ms(self._pre_step_started_ns)
