...
def And_(*args: z3.BoolRef | bool) -> z3.BoolRef:
    ...
    for a in args:
        if isinstance(a, bool):
            z3_args.append(ConstraintValues.bool(a))
        else:
            z3_args.append(a)
    if len(z3_args) == 0:
        return Z3_TRUE
...
def Not_(arg: z3.BoolRef | bool) -> z3.BoolRef:
    ...
    if isinstance(arg, bool):
        return ConstraintValues.bool(not arg)
    return z3.Not(arg)
...
def Implies_(antecedent: z3.BoolRef | bool, consequent: z3.BoolRef | bool) -> z3.BoolRef:
    ...
    """
    a = ConstraintValues.bool(antecedent) if isinstance(antecedent, bool) else antecedent
    c = ConstraintValues.bool(consequent) if isinstance(consequent, bool) else consequent
