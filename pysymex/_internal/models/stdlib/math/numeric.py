...
class MathSinModel(FunctionModel):
    ...
    def apply(
        ...
        if isinstance(x, (int, float)):
            return ModelResult(value=SymbolicValue.from_const(math.sin(x)))
        result, constraint = SymbolicValue.symbolic(f"sin_{state.pc}")
        return ModelResult(
            value=result,
            constraints=[
...
class MathCosModel(FunctionModel):
    ...
    def apply(
        ...
        x = args[0]
        if isinstance(x, (int, float)):
            return ModelResult(value=SymbolicValue.from_const(math.cos(x)))
        result, constraint = SymbolicValue.symbolic(f"cos_{state.pc}")
        return ModelResult(
            value=result,
            constraints=[
...
class MathTanModel(FunctionModel):
    ...
    def apply(
        ...
        x = args[0]
        if isinstance(x, (int, float)):
            return ModelResult(value=SymbolicValue.from_const(math.tan(x)))
        result, constraint = SymbolicValue.symbolic(f"tan_{state.pc}")
...
class MathFabsModel(FunctionModel):
    ...
    def apply(
        ...
        x = args[0]
        if isinstance(x, (int, float)):
            return ModelResult(value=SymbolicValue.from_const(math.fabs(x)))
...
class MathGcdModel(FunctionModel):
    ...
    def apply(
        ...
        if len(args) < 2:
            result, constraint = SymbolicValue.symbolic_int(f"gcd_{state.pc}")
            return ModelResult(value=result, constraints=[constraint])
        a, b = args[0], args[1]
        if isinstance(a, int) and isinstance(b, int):
            return ModelResult(value=SymbolicValue.from_const(math.gcd(a, b)))
        result, constraint = SymbolicValue.symbolic_int(f"gcd_{state.pc}")
...
class MathRadiansModel(FunctionModel):
    ...
    def apply(
        ...
        x = args[0]
        if isinstance(x, (int, float)):
            return ModelResult(value=SymbolicValue.from_const(math.radians(x)))
        if isinstance(x, SymbolicValue):
            ...
            pi_div_180 = z3.FPVal(math.pi / 180.0, z3.Float64())
            return ModelResult(
                value=result,
                constraints=[
                    constraint,
...
class MathDegreesModel(FunctionModel):
    ...
    def apply(
        ...
        x = args[0]
        if isinstance(x, (int, float)):
            return ModelResult(value=SymbolicValue.from_const(math.degrees(x)))
        if isinstance(x, SymbolicValue):
            ...
            val_180_div_pi = z3.FPVal(180.0 / math.pi, z3.Float64())
            return ModelResult(
                value=result,
                constraints=[
                    constraint,
...
class MathCopysignModel(FunctionModel):
    ...
    def apply(
        ...
        if isinstance(x, (int, float)) and isinstance(y, (int, float)):
            return ModelResult(value=SymbolicValue.from_const(math.copysign(x, y)))
