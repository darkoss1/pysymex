...
class PathExistsModel(FunctionModel):
    ...
    def apply(
        ...
        return ModelResult.bool(f"path_exists_{state.pc}", side_effects={"io": True})
...
class PathIsFileModel(FunctionModel):
    ...
    def apply(
        ...
        return ModelResult.bool(f"path_is_file_{state.pc}", side_effects={"io": True})
...
class PathIsDirModel(FunctionModel):
    ...
    def apply(
        ...
        return ModelResult.bool(f"path_is_dir_{state.pc}", side_effects={"io": True})
