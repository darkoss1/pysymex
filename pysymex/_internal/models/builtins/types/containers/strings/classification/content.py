...
class StrIsdigitModel(FunctionModel):
    ...
    def apply(
        ...
        result, constraint = SymbolicValue.symbolic_bool(f"isdigit_{state.pc}")
...
class StrIsalphaModel(FunctionModel):
    ...
    def apply(
        ...
        if exact is not None:
            return ModelResult(value=SymbolicValue.from_const(exact))
        original = SymbolicString.resolve(args[0]) if args else None
        result, constraint = SymbolicValue.symbolic_bool(f"isalpha_{state.pc}")
        constraints = [constraint]
        if original is not None:
            constraints.append(z3.Implies(original.z3_len == 0, z3.Not(result.z3_bool)))
        return ModelResult(value=result, constraints=constraints)
...
class StrIsalnumModel(FunctionModel):
    ...
    def apply(
        ...
        if exact is not None:
            return ModelResult(value=SymbolicValue.from_const(exact))
        original = SymbolicString.resolve(args[0]) if args else None
        result, constraint = SymbolicValue.symbolic_bool(f"isalnum_{state.pc}")
        constraints = [constraint]
        if original is not None:
            constraints.append(z3.Implies(original.z3_len == 0, z3.Not(result.z3_bool)))
        return ModelResult(value=result, constraints=constraints)
...
class StrIsspaceModel(FunctionModel):
    ...
    def apply(
        ...
        if exact is not None:
            return ModelResult(value=SymbolicValue.from_const(exact))
        original = SymbolicString.resolve(args[0]) if args else None
        result, constraint = SymbolicValue.symbolic_bool(f"isspace_{state.pc}")
        constraints = [constraint]
        if original is not None:
            constraints.append(z3.Implies(original.z3_len == 0, z3.Not(result.z3_bool)))
        return ModelResult(value=result, constraints=constraints)
...
class StrIsdecimalModel(FunctionModel):
    ...
    def apply(
        ...
        if exact is not None:
            return ModelResult(value=SymbolicValue.from_const(exact))
        original = SymbolicString.resolve(args[0]) if args else None
        result, constraint = SymbolicValue.symbolic_bool(f"isdecimal_{state.pc}")
        constraints = [constraint]
        if original is not None:
            constraints.append(z3.Implies(original.z3_len == 0, z3.Not(result.z3_bool)))
        return ModelResult(value=result, constraints=constraints)
...
class StrIsnumericModel(FunctionModel):
    ...
    def apply(
        ...
        if exact is not None:
            return ModelResult(value=SymbolicValue.from_const(exact))
        original = SymbolicString.resolve(args[0]) if args else None
        result, constraint = SymbolicValue.symbolic_bool(f"isnumeric_{state.pc}")
        constraints = [constraint]
        if original is not None:
            constraints.append(z3.Implies(original.z3_len == 0, z3.Not(result.z3_bool)))
        return ModelResult(value=result, constraints=constraints)
