...
delegating to :mod:`pysymex._internal.execution.opcodes.common.functions`. Does not own
...
def handle_py313_make_function(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_load_build_class(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_load_super_attr(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_load_super_variants(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_call_function_ex(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_set_function_attribute(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
handle_kw_names = handle_py313_kw_names
handle_import_star = handle_py313_import_star
handle_call = handle_py313_call
handle_load_method = handle_py313_load_method
handle_store_attr = handle_py313_store_attr
handle_delete_attr = handle_py313_delete_attr
handle_make_function = handle_py313_make_function
handle_load_build_class = handle_py313_load_build_class
handle_import_name = handle_py313_import_name
handle_import_from = handle_py313_import_from
handle_load_super_attr = handle_py313_load_super_attr
handle_load_super_variants = handle_py313_load_super_variants
handle_call_function_ex = handle_py313_call_function_ex
handle_set_function_attribute = handle_py313_set_function_attribute
