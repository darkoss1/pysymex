...
"""Local and global variable opcodes (Python 3.13).
...
from pysymex._internal.execution.opcodes.common.locals.fused import (
    handle_common_load_fast_load_fast,
    handle_common_store_fast_load_fast,
    handle_common_store_fast_store_fast,
)
...
def handle_py313_load_fast_check(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_delete_global(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_load_fast_and_clear(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_store_fast_maybe_null(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
    """Store to local that might be uninitialized (exception handling)."""
    return handle_common_store_fast_maybe_null(instr, state, ctx)


@opcode_handler("LOAD_FROM_DICT_OR_DEREF")
def py313_load_from_dict_or_deref(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_load_from_dict_or_globals(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_setup_annotations(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_copy_free_vars(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_load_fast_load_fast(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
    """Handle fused load fast load fast (Python 3.13+)."""
    return handle_common_load_fast_load_fast(instr, state, ctx)


@opcode_handler("STORE_FAST_LOAD_FAST")
def handle_py313_store_fast_load_fast(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
    """Handle fused store fast load fast (Python 3.13+)."""
    return handle_common_store_fast_load_fast(instr, state, ctx)


@opcode_handler("STORE_FAST_STORE_FAST")
def handle_py313_store_fast_store_fast(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
    """Handle fused store fast store fast (Python 3.13+)."""
    return handle_common_store_fast_store_fast(instr, state, ctx)


handle_load_const = handle_py313_load_const
handle_load_fast = handle_py313_load_fast
handle_load_fast_check = handle_py313_load_fast_check
handle_store_fast = handle_py313_store_fast
handle_delete_fast = handle_py313_delete_fast
handle_load_global = handle_py313_load_global
handle_store_global = handle_py313_store_global
handle_delete_global = handle_py313_delete_global
handle_load_name = handle_py313_load_name
handle_store_name = handle_py313_store_name
handle_delete_name = handle_py313_delete_name
handle_load_deref = handle_py313_load_deref
handle_store_deref = handle_py313_store_deref
handle_cell_ops = handle_py313_cell_ops
handle_delete_deref = handle_py313_delete_deref
handle_load_fast_and_clear = handle_py313_load_fast_and_clear
handle_store_fast_maybe_null = handle_py313_store_fast_maybe_null
handle_load_from_dict_or_deref = py313_load_from_dict_or_deref
handle_load_from_dict_or_globals = handle_py313_load_from_dict_or_globals
handle_load_locals = handle_py313_load_locals
handle_setup_annotations = handle_py313_setup_annotations
handle_load_closure = handle_py313_load_closure
handle_copy_free_vars = handle_py313_copy_free_vars
handle_load_fast_load_fast = handle_py313_load_fast_load_fast
handle_store_fast_load_fast = handle_py313_store_fast_load_fast
handle_store_fast_store_fast = handle_py313_store_fast_store_fast
