...
def handle_py313_build_const_key_map(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_collection_update(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_binary_subscr(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_delete_subscr(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_unpack_sequence(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py313_dict_merge_update(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
handle_build_list = handle_py313_build_list
handle_build_tuple = handle_py313_build_tuple
handle_build_set = handle_py313_build_set
handle_build_map = handle_py313_build_map
handle_build_const_key_map = handle_py313_build_const_key_map
handle_build_string = handle_py313_build_string
handle_build_slice = handle_py313_build_slice
handle_list_extend = handle_py313_list_extend
handle_collection_update = handle_py313_collection_update
handle_list_append = handle_py313_list_append
handle_set_add = handle_py313_set_add
handle_map_add = handle_py313_map_add
handle_binary_subscr = handle_py313_binary_subscr
handle_store_subscr = handle_py313_store_subscr
handle_delete_subscr = handle_py313_delete_subscr
handle_binary_slice = handle_py313_binary_slice
handle_store_slice = handle_py313_store_slice
handle_unpack_sequence = handle_py313_unpack_sequence
handle_unpack_ex = handle_py313_unpack_ex
handle_dict_merge_update = handle_py313_dict_merge_update
