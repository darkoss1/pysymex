...
def handle_py311_precall(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
    """Handle PRECALL."""
    return handle_common_precall(instr, state, ctx)


@opcode_handler("KW_NAMES")
def handle_py311_kw_names(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py311_make_function(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py311_load_build_class(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py311_call_function_ex(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
handle_precall = handle_py311_precall
handle_kw_names = handle_py311_kw_names
handle_import_star = handle_py311_import_star
handle_call = handle_py311_call
handle_load_method = handle_py311_load_method
handle_store_attr = handle_py311_store_attr
handle_delete_attr = handle_py311_delete_attr
handle_make_function = handle_py311_make_function
handle_load_build_class = handle_py311_load_build_class
handle_import_name = handle_py311_import_name
handle_import_from = handle_py311_import_from
handle_call_function_ex = handle_py311_call_function_ex
