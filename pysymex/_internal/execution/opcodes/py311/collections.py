...
def handle_py311_build_const_key_map(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py311_collection_update(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py311_binary_subscr(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py311_delete_subscr(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py311_unpack_sequence(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py311_dict_merge_update(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
handle_build_list = handle_py311_build_list
handle_build_tuple = handle_py311_build_tuple
handle_build_set = handle_py311_build_set
handle_build_map = handle_py311_build_map
handle_build_const_key_map = handle_py311_build_const_key_map
handle_build_string = handle_py311_build_string
handle_build_slice = handle_py311_build_slice
handle_list_extend = handle_py311_list_extend
handle_collection_update = handle_py311_collection_update
handle_list_append = handle_py311_list_append
handle_set_add = handle_py311_set_add
handle_map_add = handle_py311_map_add
handle_binary_subscr = handle_py311_binary_subscr
handle_store_subscr = handle_py311_store_subscr
handle_delete_subscr = handle_py311_delete_subscr
handle_unpack_sequence = handle_py311_unpack_sequence
handle_unpack_ex = handle_py311_unpack_ex
handle_dict_merge_update = handle_py311_dict_merge_update
