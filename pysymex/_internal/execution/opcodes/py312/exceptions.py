...
def handle_py312_setup_finally(
...
def handle_py312_push_exc_info(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py312_check_exc_match(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py312_cleanup_throw(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py312_with_except_start(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py312_before_async_with(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py312_end_async_for(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py312_get_awaitable(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py312_get_yield_from_iter(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py312_check_eg_match(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py312_setup_cleanup(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py312_interpreter_exit(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
def handle_py312_return_generator(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
...
handle_setup_finally = handle_py312_setup_finally
handle_setup_with = handle_py312_setup_with
handle_pop_block = handle_py312_pop_block
handle_push_exc_info = handle_py312_push_exc_info
handle_pop_except = handle_py312_pop_except
handle_check_exc_match = handle_py312_check_exc_match
handle_cleanup_throw = handle_py312_cleanup_throw
handle_reraise = handle_py312_reraise
handle_with_except_start = handle_py312_with_except_start
handle_before_with = handle_py312_before_with
handle_before_async_with = handle_py312_before_async_with
handle_end_async_for = handle_py312_end_async_for
handle_get_aiter = handle_py312_get_aiter
handle_get_anext = handle_py312_get_anext
handle_get_awaitable = handle_py312_get_awaitable
handle_send = handle_py312_send
handle_yield_value = handle_py312_yield_value
handle_end_send = handle_py312_end_send
handle_get_yield_from_iter = handle_py312_get_yield_from_iter
handle_check_eg_match = handle_py312_check_eg_match
handle_setup_cleanup = handle_py312_setup_cleanup
handle_interpreter_exit = handle_py312_interpreter_exit
handle_raise_varargs = py312_raise_varargs
handle_return_generator = handle_py312_return_generator
