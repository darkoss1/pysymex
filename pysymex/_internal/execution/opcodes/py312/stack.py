...
"""Stack manipulation opcode wrappers for Python 3.12.
...
def handle_py312_instrumented(
    instr: dis.Instruction,
    state: VMState,
    ctx: OpcodeDispatcher,
) -> OpcodeResult:
    """Unsupported instrumented pseudo-opcode (Python 3.12/3.13 monitoring)."""
    return handle_common_instrumented(instr, state, ctx)


handle_pop_top = handle_py312_pop_top
handle_copy = handle_py312_copy
handle_swap = handle_py312_swap
handle_extended_arg = handle_py312_extended_arg
handle_push_null = handle_py312_push_null
handle_cache = handle_py312_cache
handle_instrumented = handle_py312_instrumented
