...
"""Verified path-constraint suffix persistence."""
...
def persist_verified_constraint_suffix(
    *,
    solver: SolverProtocol,
    constraints: list[z3.BoolRef],
    known_prefix_len: int,
) -> None:
    """Persist constraints that were proven feasible past the known SAT prefix."""
