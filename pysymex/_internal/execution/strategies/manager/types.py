...
:class:`~pysymex._internal.execution.executors.core.SymbolicExecutor` and implemented by
:class:`~pysymex._internal.execution.strategies.manager.path.PolarCegisPathManager`.
"""
...
class PrioritizedState(Generic[T]):
    ...
    __slots__ = ("counter", "priority", "state")

    def __init__(self, priority: float, counter: int, state: T) -> None:
