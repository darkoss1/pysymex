...
shared sentinel identity. Keeping them outside ``pysymex._internal.core.solver`` also
...
Z3_BYTE_SORT: z3.BitVecSortRef = z3.BitVecSort(8)
Z3_EMPTY_BYTES: z3.SeqRef = z3.Empty(z3.SeqSort(Z3_BYTE_SORT))
