...
class ValueAdditiveMixin:
    ...
    def __add__(self: SymbolicValueSelf, other: object) -> SymbolicValueSelf:
        ...
        concrete = ScalarValueOps.apply_concrete_numeric_binary_op(self, other, lambda a, b: a + b)
