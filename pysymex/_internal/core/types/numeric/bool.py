...
class SymbolicBool(SymbolicType):
    ...
    def _to_bool_expr(self, value: object) -> z3.BoolRef | None:
    ...
    def __and__(self, other: SymbolicBool | bool) -> SymbolicBool:
        """Return conjunction of two Boolean carrier expressions."""
        other_bool = self._to_bool_expr(other)
        if other_bool is None:
            return NotImplemented
        return SymbolicBool(z3.And(self.z3_bool, other_bool))

    def __rand__(self, other: SymbolicBool | bool) -> SymbolicBool:
        return self.__and__(other)

    def __or__(self, other: SymbolicBool | bool) -> SymbolicBool:
        """Return disjunction of two Boolean carrier expressions."""
        other_bool = self._to_bool_expr(other)
        if other_bool is None:
            return NotImplemented
        return SymbolicBool(z3.Or(self.z3_bool, other_bool))

    def __ror__(self, other: SymbolicBool | bool) -> SymbolicBool:
    ...
    def __xor__(self, other: SymbolicBool | bool) -> SymbolicBool:
        """Return exclusive disjunction of two Boolean carrier expressions."""
        other_bool = self._to_bool_expr(other)
        if other_bool is None:
            return NotImplemented
        return SymbolicBool(z3.Xor(self.z3_bool, other_bool))

    def __rxor__(self, other: SymbolicBool | bool) -> SymbolicBool:
