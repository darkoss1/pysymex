...
from pysymex._internal.core.solver.engine.cache.results import SolverCacheMixin
...
from pysymex._internal.core.solver.engine.lifecycle import SolverLifecycleMixin
from pysymex._internal.core.solver.engine.models import SolverModelMixin
from pysymex._internal.core.solver.engine.sat import SolverSatMixin
from pysymex._internal.core.solver.engine.scopes import SolverScopeMixin
from pysymex._internal.core.solver.engine.translation import SolverTranslationMixin
...
class IncrementalSolver(
    ...
    def __init__(
        ...
        self._scope_depth = 0
        self.cache: OrderedDict[tuple[int, tuple[str | int, ...]], SolverResult] = OrderedDict()
        self._cache_index: dict[int, set[tuple[str | int, ...]]] = {}
        self._cache_identity_constraints: dict[
            tuple[int, tuple[str | int, ...]],
            tuple[z3.BoolRef, ...],
        ] = {}
        self._quick_sat_cache: OrderedDict[
            tuple[int, tuple[int, ...]],
        ...
        self._optimizer = IndependenceOptimizer()
