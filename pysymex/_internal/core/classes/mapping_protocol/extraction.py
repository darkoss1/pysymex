...
"""Modeled mapping-protocol extraction for dict update semantics.
...
from pysymex._internal.core.classes.mapping_protocol.patterns.attributes import (
...
from pysymex._internal.core.classes.mapping_protocol.patterns.items import (
    static_item_mapping,
)
...
from pysymex._internal.core.types.concrete_extraction import (
    register_modeled_mapping_extractor,
)

register_modeled_mapping_extractor(extract_modeled_instance_mapping)
