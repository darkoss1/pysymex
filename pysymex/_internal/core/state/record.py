...
from pysymex._internal.core.state.fork import VMStateForkMixin
from pysymex._internal.core.state.mutation import VMStateMutationMixin
...
class StateConstraints:
    ...
    known_sat_prefix_len = staticmethod(_known_sat_prefix_len)
