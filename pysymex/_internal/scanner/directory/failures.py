...
def build_failed_scan_result(file_path: Path, exc: Exception) -> ScanResult:
    ...
    Returns:
        A :class:`~pysymex._internal.scanner.types.ScanResult` containing the error message.
    ...
    return ScanResult(
        ...
        outcome_evidence=[OutcomePolicy.evidence_from_exception(exc, source="scanner.directory")],
    )
