...
from pysymex._internal.cli.formatters.text.symbolic.mixin import SymbolicTextMixin
from pysymex._internal.cli.formatters.text.verify import VerifyTextMixin

if TYPE_CHECKING:
    from collections.abc import Sequence


class CliTextFormatter(SymbolicTextMixin, VerifyTextMixin):
