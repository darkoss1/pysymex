...
"""Issue construction for bytearray modulo-index preflight diagnostics."""
...
def append_modulo_index_issue(
    ...
    """Append a stable modulo-index diagnostic if this source site is new."""
