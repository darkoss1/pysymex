...
"""Issue construction for self-canceling zero-division preflight diagnostics."""
...
def append_self_canceling_issue(
    ...
    """Append a stable self-canceling zero-division diagnostic."""
