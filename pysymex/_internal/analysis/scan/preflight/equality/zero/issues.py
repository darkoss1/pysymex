...
"""Issue construction for equality-guarded zero-division preflight diagnostics."""
...
def append_equality_zero_issue(
    ...
    """Append a stable equality-guarded zero-division diagnostic."""
