...
class ResourceLimits:
    """Host engine limits enforced by :class:`~pysymex.resources.tracker.ResourceTracker`.

    Profile/TOML limits use :class:`~pysymex.config.sections.AnalysisLimits` and convert
    via :func:`~pysymex.resources.mapping.resource_limits_from_analysis_limits`.
    """
    ...
    max_constraints: int = DEFAULT_LIMIT_MAX_CONSTRAINT_SIZE
