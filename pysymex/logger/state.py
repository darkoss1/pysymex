...
from pysymex.logger.formatting import supports_color
...
class LoggerState:
    ...
    debug_enabled: bool
    trace_enabled: bool
    sinks: list[LogSink] = field(default_factory=lambda: list[LogSink]())
    ...
    counters: dict[str, int] = field(default_factory=lambda: dict[str, int]())
...
__all__ = ["LoggerState", "create_logger_state"]
