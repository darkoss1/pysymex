...
"""Build execution result objects from completed execution sessions."""
...
from pysymex.execution.fallback import FallbackKind, SoundnessTag
...
def build_execution_result(
    *,
    ...
    """Build the public execution result from finalized run data.

    The builder owns the mapping from session/resource/solver data into
    :class:`~pysymex.execution.results.result.ExecutionResult`. It does not run
    detectors, decide path feasibility, mutate the worklist, or filter issues.
    """
