...
from pysymex.core.types.havoc import havoc_values_may_exist, is_havoc

__all__ = ["EvidenceDigest", "detector_obligation_digest", "havoc_root_count"]

EvidenceDigest: TypeAlias = tuple[object, ...]
