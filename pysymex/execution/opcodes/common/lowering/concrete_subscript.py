...
Returns :class:`~pysymex.execution.opcodes.common.lowering.types.LoweredValue`
...
from pysymex.execution.opcodes.common.lowering.types import LoweredValue
...
def concrete_int_index(index: StackValue) -> int | None:
    ...
    if isinstance(index, SymbolicValue):
        ...
        if isinstance(value, int):
            return value
        simplified_index = z3.simplify(index.z3_int)
