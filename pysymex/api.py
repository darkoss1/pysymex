...
def analyze(
    ...
    *,
    ...
    This is the main entry point for pysymex. It performs symbolic execution
...
def quick_check(func: Callable[..., Any]) -> list[Issue]:
    """
...
def check_division_by_zero(func: Callable[..., Any]) -> list[Issue]:
    """
...
def check_assertions(func: Callable[..., Any]) -> list[Issue]:
    """
...
def check_index_errors(func: Callable[..., Any]) -> list[Issue]:
    """
...
check: Callable[..., Any] = analyze

scan: Callable[..., Any] = analyze_file
...
def scan_static(
    ...
    Returns:
        List of ScanIssue objects found
    """
...
def scan_pipeline(
    ...
    Uses AnalysisPipeline which integrates type inference, flow-sensitive
    analysis, pattern recognition, taint analysis, and abstract interpretation.
    ...
    Args:
        ...
        taint_analysis: Enable taint analysis
