...
class WindowsNativeJobMixin:
    ...
    def create_configured_job_object(
        ...
        *,
        ...
        if not job:
            raise SandboxSetupError("Failed to create Windows AppContainer Job Object")
        ...
        if not ok:
            ...
            raise SandboxSetupError("Failed to configure Windows AppContainer Job Object limits")
        ...
        if not ok_ui:
            ...
            if not ok_ui:
                ...
                raise SandboxSetupError(
                    "Failed to configure Windows AppContainer Job Object UI restrictions"
                )
