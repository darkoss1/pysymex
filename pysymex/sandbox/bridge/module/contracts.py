...
_CONTRACT_SOURCE_TEMPLATE = r"""        class _EnumValue:
        ...
        _fake_contracts_decorators = types.ModuleType("pysymex.contracts.decorators")
        _fake_contracts_types = types.ModuleType("pysymex.contracts.types")
        for _mod in (_fake_contracts, _fake_contracts_decorators):
            ...
            _mod.Severity = _SandboxSeverity
        _fake_contracts_types.Severity = _SandboxSeverity
        ...
        _FAKE_MODULES = {{
            ...
            "pysymex.contracts.decorators": _fake_contracts_decorators,
            "pysymex.contracts.types": _fake_contracts_types,
        }}
