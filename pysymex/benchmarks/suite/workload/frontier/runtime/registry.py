...
_FRONTIER_RUNTIME_BENCHMARKS = (
    _FrontierRuntimeBenchmarkSpec(
        ...
        aliases=("frontier_runtime_cegis_exact_pruning",),
    ),
    _FrontierRuntimeBenchmarkSpec(
        name="cegis_dedupe",
        ...
        aliases=("frontier_runtime_cegis_dominance_pruning",),
    ),
    _FrontierRuntimeBenchmarkSpec(
        name="cegis_core",
        ...
        aliases=("frontier_runtime_cegis_core_reuse_pruning",),
    ),
    _FrontierRuntimeBenchmarkSpec(
        ...
        aliases=("frontier_runtime_pressure_compaction",),
    ),
)
    ...
    for benchmark_spec in _FRONTIER_RUNTIME_BENCHMARKS:
        suite.add(
            Benchmark(
                ...
                aliases=benchmark_spec.aliases,
            )
        )
