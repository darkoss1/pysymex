...
if TYPE_CHECKING:
    from .analysis import BuiltinModels as BuiltinModels
    from .methods import MethodModels as MethodModels
...
class FunctionSummarizer:
    ...
    def get_summary(self, name: str) -> FunctionSummary | None:
        ...
        from .analysis import BuiltinModels
    ...
    def get_method_summary(
        ...
        from .methods import MethodModels
...
_EXPORTS: dict[str, tuple[str, str]] = {
    "BuiltinModels": ("pysymex.models.builtins.analysis", "BuiltinModels"),
    "MethodModels": ("pysymex.models.builtins.methods", "MethodModels"),
}
