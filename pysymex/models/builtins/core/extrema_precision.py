...
from ..base import ModelResult, SideEffectValue
from .iterator_items import (
    concrete_iterable_items as _shared_concrete_iterable_items,
    iterator_exhaustion_side_effect as _raw_iterator_exhaustion_side_effect,
)
from .sum_precision import contains_symbolic_operand, int_operand_expr
...
def iterator_exhaustion_side_effect(
    ...
    return cast(
        "dict[str, SideEffectValue] | None",
        _raw_iterator_exhaustion_side_effect(value, state),
    )
