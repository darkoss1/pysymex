...
class DefaultDictConstructorModel(FunctionModel):
    ...
    def apply(
        ...
        setattr(storage, "_has_default_factory", True)
        address = next_address()
        handle = SymbolicObject(f"defaultdict_{address}", address, get_int_val(address), {address})
...
__all__ = ["DEFAULTDICT_MODELS", "DefaultDictConstructorModel", "DefaultDictModel"]
