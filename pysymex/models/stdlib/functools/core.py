...
from pysymex.models.builtins.results import SideEffectValue
...
def apply_transparent_decorator_call(
    func_obj: object, args: list[object], kwargs: dict[str, object]
) -> object | None:
...
def _definitely_empty_iterable(value: object, state: VMState) -> bool:
    ...
    return (
        isinstance(value, SymbolicList)
        and z3.is_int_value(value.z3_len)
        and value.z3_len.as_long() == 0
    )
...
__all__ = [
    "PartialConstructorModel",
    "PartialModel",
    "ReduceModel",
    "TransparentDecorator",
    "WrappedWrapper",
    "apply_transparent_decorator_call",
    "model_partial",
    "model_reduce",
