...
def stub_closing(obj: object) -> object:
    """Stub closing."""
    return obj


def stub_aclosing(obj: object) -> object:
    """Stub aclosing."""
    return obj
...
def stub_redirect_stdout(_new_target: object) -> RedirectStdout:
    """Stub redirect stdout."""
    return RedirectStdout()


def stub_redirect_stderr(_new_target: object) -> RedirectStderr:
