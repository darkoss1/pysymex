    ...
    def apply(
        ...
        if isinstance(val, (list, tuple, set)):
            ...
            return ModelResult(
                ...
                constraints=[
                    constraint,
                    result.z3_int == len(set(cast(list[Any] | tuple[Any, ...] | set[Any], val))),
                ],
            )
...
class ReversedModel(FunctionModel):
    ...
    def apply(
        ...
        if isinstance(val, (list, tuple, str)):
            return ModelResult(value=list(reversed(cast(list[Any] | tuple[Any, ...] | str, val))))
...
class AllModel(FunctionModel):
    ...
    def apply(
        ...
        if isinstance(val, (list, tuple)):
            ...
            val_seq = cast(list[Any] | tuple[Any, ...], val)
            ...
            if isinstance(obj, (int, str, float, tuple, frozenset, type(None))):
                return ModelResult(
                    value=SymbolicValue.from_const(
                        hash(cast(int | str | float | tuple[Any, ...] | frozenset[Any] | None, obj))
                    )
                )
