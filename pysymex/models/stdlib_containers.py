    ...
    def apply(self, args: list[Any], kwargs: dict[str, Any], state: VMState) -> ModelResult:
        ...
        if args and isinstance(args[0], (list, tuple)):
            return ModelResult(
                ...
                constraints=[
                    constraint,
                    result.z3_len == len(cast(list[Any] | tuple[Any, ...], args[0])),
                ],
            )
    ...
    def apply(self, args: list[Any], kwargs: dict[str, Any], state: VMState) -> ModelResult:
        ...
        for arg in args:
            if isinstance(arg, SymbolicList):
                ...
                total_len = total_len + len(cast(list[Any] | tuple[Any, ...], arg))
    ...
    def apply(self, args: list[Any], kwargs: dict[str, Any], state: VMState) -> ModelResult:
        ...
        for arg in args:
            if isinstance(arg, SymbolicList):
                ...
                product_len = product_len * len(cast(list[Any] | tuple[Any, ...], arg))
