...
def model_count(start: int = 0, step: int = 1) -> Any:
...
def model_repeat(obj: Any, times: int | None = None) -> SymbolicList:
...
ITERTOOLS_MODELS: dict[str, Callable[..., Any]] = {
    "chain": model_chain,
...
def get_itertools_model(name: str) -> Callable[..., Any] | None:
...
def register_itertools_models() -> dict[str, Callable[..., Any]]:
