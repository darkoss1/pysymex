...
def model_partial(func: Callable[..., Any], *args: Any, **kwargs: Any) -> PartialModel:
...
def model_cached_property(func: Callable[..., Any]) -> CachedPropertyModel:
...
def model_wraps(wrapped: Callable[..., Any], **kwargs: Any) -> Callable[..., Any]:
...
def model_cmp_to_key(mycmp: Callable[..., Any]) -> type:
...
def model_singledispatch(func: Callable[..., Any]) -> Callable[..., Any]:
...
FUNCTOOLS_MODELS: dict[str, Callable[..., Any]] = {
...
def get_functools_model(name: str) -> Callable[..., Any] | None:
...
def register_functools_models() -> dict[str, Callable[..., Any]]:
