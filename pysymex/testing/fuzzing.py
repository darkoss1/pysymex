...
class ConformanceGenerator:
    ...
    def add_statement_test(
        ...
        try:
            ...
            result: Any = namespace.get(check_var)
    ...
    def to_pytest_code(self) -> str:
        ...
        for test in self.tests:
            ...
            if test.expected_exception:
                ...
                lines.append(f"            eval({repr(test.code)})")

            else:
                lines.append(f"        result = eval({repr(test.code)})")
