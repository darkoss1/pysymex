...
class HandlerPlugin(Plugin):
    ...
    def activate(self, engine: SymbolicEngine) -> None:
        ...
        handlers: dict[str, Callable[..., Any]] = self.get_handlers()
...
class HookPlugin(Plugin):
    ...
    def activate(self, engine: SymbolicEngine) -> None:
        ...
        hooks: dict[str, Callable[..., Any]] = self.get_hooks()
...
class PluginRegistry:
    ...
    def __init__(self):
        ...
        self._hooks: dict[str, list[Callable[..., Any]]] = {name: [] for name in HOOKS}
