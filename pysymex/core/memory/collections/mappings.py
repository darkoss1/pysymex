...
class SymbolicDictOps:
    ...
    @staticmethod
    def length(d: dict[_K, _V] | SymbolicDict | SymbolicMap) -> OpResult:
    ...
    @staticmethod
    def getitem(d: dict[_K, _V] | SymbolicDict | SymbolicMap, key: object) -> OpResult:
        """Get value for key."""
        if isinstance(d, dict):
            concrete_d = cast("dict[object, object]", d)
            if key in d:
                return OpResult(value=concrete_d[key])
            else:
    ...
    @staticmethod
    def setitem(d: dict[_K, _V] | SymbolicMap, key: object, value: object) -> OpResult:
        """Set value for key."""
        if isinstance(d, dict):
            concrete_d = cast("dict[object, object]", d)
            concrete_d[key] = value
            return OpResult(value=None, modified_collection=concrete_d)
        else:
            assert isinstance(d, SymbolicMap)
            z3_key = cast(
                "z3.ExprRef",
    ...
    @staticmethod
    def delitem(d: dict[_K, _V] | SymbolicMap, key: object) -> OpResult:
    ...
    @staticmethod
    def get(d: dict[_K, _V] | SymbolicMap, key: object, default: object = None) -> OpResult:
        """Get value for key with default."""
        if isinstance(d, dict):
            concrete_d = cast("dict[object, object]", d)
            return OpResult(value=concrete_d.get(key, default))
        else:
            assert isinstance(d, SymbolicMap)
            z3_key = cast(
                "z3.ExprRef",
    ...
    @staticmethod
    def contains(d: dict[_K, _V] | SymbolicMap, key: object) -> OpResult:
    ...
    @staticmethod
    def pop(d: dict[_K, _V] | SymbolicMap, key: object, default: object = None) -> OpResult:
        """Remove and return value for key."""
        if isinstance(d, dict):
            concrete_d = cast("dict[object, object]", d)
            if key in d:
                pop_value: object = concrete_d.pop(key)
                return OpResult(value=pop_value, modified_collection=concrete_d)
            elif default is not None:
                return OpResult(value=default, modified_collection=concrete_d)
            else:
                return OpResult(value=None, error="KeyError")
        else:
            assert isinstance(d, SymbolicMap)
    ...
    def setdefault(d: dict[_K, _V] | SymbolicMap, key: object, default: object = None) -> OpResult:
        ...
        if isinstance(d, dict):
            concrete_d = cast("dict[object, object]", d)
            if key not in d:
                concrete_d[key] = default
            return OpResult(value=concrete_d[key], modified_collection=concrete_d)
        else:
            assert isinstance(d, SymbolicMap)
            z3_key = cast(
                "z3.ExprRef",
    ...
    @staticmethod
    def keys(d: dict[_K, _V] | SymbolicMap) -> OpResult:
        """Get dict keys."""
        if isinstance(d, dict):
    ...
    @staticmethod
    def values(d: dict[_K, _V] | SymbolicMap) -> OpResult:
        """Get dict values."""
        if isinstance(d, dict):
    ...
    @staticmethod
    def items(d: dict[_K, _V] | SymbolicMap) -> OpResult:
        """Get dict items."""
        if isinstance(d, dict):
...
class SymbolicSetOps:
    ...
    @staticmethod
    def length(s: set[_S] | SymbolicSet) -> OpResult:
        """Get set cardinality."""
        if isinstance(s, set):
    ...
    @staticmethod
    def contains(s: set[_S] | SymbolicSet, value: object) -> OpResult:
    ...
    @staticmethod
    def add(s: set[_S] | SymbolicSet, value: object) -> OpResult:
        """Add value to set."""
        if isinstance(s, set):
            concrete_s = cast("set[object]", s)
            concrete_s.add(value)
            return OpResult(value=None, modified_collection=concrete_s)
        else:
            assert isinstance(s, SymbolicSet)
            sym_val = (
                value
    ...
    @staticmethod
    def remove(s: set[_S] | SymbolicSet, value: object) -> OpResult:
        """Remove value from set (raises error if not present)."""
        if isinstance(s, set):
            concrete_s = cast("set[object]", s)
            if value in s:
                concrete_s.remove(value)
                return OpResult(value=None, modified_collection=concrete_s)
            else:
                return OpResult(value=None, error="KeyError")
        else:
    ...
    @staticmethod
    def discard(s: set[_S] | SymbolicSet, value: object) -> OpResult:
        """Remove value from set if present."""
        if isinstance(s, set):
            concrete_s = cast("set[object]", s)
            concrete_s.discard(value)
            return OpResult(value=None, modified_collection=concrete_s)
        else:
            assert isinstance(s, SymbolicSet)
            sym_val = (
    ...
    @staticmethod
    def pop(s: set[_S] | SymbolicSet) -> OpResult:
    ...
    @staticmethod
    def union(s1: set[_S] | SymbolicSet, s2: set[_S] | SymbolicSet) -> OpResult:
    ...
    @staticmethod
    def intersection(s1: set[_S] | SymbolicSet, s2: set[_S] | SymbolicSet) -> OpResult:
    ...
    @staticmethod
    def difference(s1: set[_S] | SymbolicSet, s2: set[_S] | SymbolicSet) -> OpResult:
