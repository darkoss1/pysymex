...
class EnhancedClass:
    ...
    class_vars: dict[str, Any] = field(default_factory=dict[str, Any])

    slots: tuple[str, ...] | None = None

    is_dataclass: bool = False

    dataclass_fields: dict[str, Any] = field(default_factory=dict[str, Any])
...
class EnhancedObject:
    ...
    init_values: dict[str, Any] = field(default_factory=dict[str, Any])
