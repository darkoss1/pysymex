...
class SymbolicListOps:
    ...
    @staticmethod
    def length(lst: list[Any] | SymbolicList | SymbolicArray) -> OpResult:
    ...
    @staticmethod
    def getitem(
        lst: list[Any] | SymbolicList | SymbolicArray, index: int | z3.ArithRef | SymbolicInt
    ) -> OpResult:
    ...
    @staticmethod
    def setitem(
        lst: list[Any] | SymbolicArray, index: int | z3.ArithRef | SymbolicInt, value: Any
    ) -> OpResult:
        """Set item at index."""
    ...
    @staticmethod
    def append(lst: list[Any] | SymbolicArray, value: Any) -> OpResult:
    ...
    @staticmethod
    def extend(lst: list[Any] | SymbolicArray, items: list[Any] | SymbolicArray) -> OpResult:
    ...
    @staticmethod
    def pop(lst: list[Any] | SymbolicArray, index: int | z3.ArithRef | None = None) -> OpResult:
    ...
    @staticmethod
    def insert(lst: list[Any] | SymbolicArray, index: int | z3.ArithRef, value: Any) -> OpResult:
    ...
    @staticmethod
    def remove(lst: list[Any] | SymbolicArray, value: Any) -> OpResult:
    ...
    @staticmethod
    def index(
        lst: list[Any] | SymbolicArray, value: Any, start: int = 0, stop: int | None = None
    ) -> OpResult:
    ...
    @staticmethod
    def count(lst: list[Any] | SymbolicArray, value: Any) -> OpResult:
    ...
    @staticmethod
    def reverse(lst: list[Any] | SymbolicArray) -> OpResult:
    ...
    @staticmethod
    def contains(lst: list[Any] | SymbolicArray, value: Any) -> OpResult:
    ...
    def slice(
        ...
        if isinstance(lst, list):
            result: list[Any] = lst[start:stop:step]
    ...
    @staticmethod
    def concatenate(lst1: list[Any] | SymbolicArray, lst2: list[Any] | SymbolicArray) -> OpResult:
