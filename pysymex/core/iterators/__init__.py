"""Iterator protocol public exports and factories."""
...
from pysymex.core.iterators.base import (
	IterationResult,
	IteratorState,
	SymbolicIterator,
	SymbolicRange,
...
from pysymex.core.iterators.combinators import (
	LoopBounds,
...
def create_iterator(iterable: object, name: str = "iter") -> SymbolicIterator:
	...
	try:
		return SymbolicSequenceIterator(sequence=list(cast("Iterable[object]", iterable)), _name=name)
...
def collect_iterator(
	...
	"""Collect all values and path constraints from an iterator."""
	values: list[object] = []
