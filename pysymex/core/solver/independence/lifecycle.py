...
from pysymex.core.solver.independence.helpers import as_z3_expr
from pysymex.core.solver.independence.union_find import UnionFind


class ConstraintIndependenceLifecycleMixin:
    ...
    def find_group_root(self, variable: str) -> str:
        """Return the dependency-group root, registering ``variable`` if unseen."""
...
__all__ = ["ConstraintIndependenceLifecycleMixin"]
