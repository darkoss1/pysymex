...
from pysymex.core.graph.union_find import UnionFind as _CoreUnionFind


class UnionFind:
    """Solver-facing union-find with auto-creating string keys.

    The disjoint-set algorithm is owned by :mod:`pysymex.core.graph.union_find`.
    ...
    def __init__(self) -> None:
        ...
        self._sets: _CoreUnionFind[str] = _CoreUnionFind()
