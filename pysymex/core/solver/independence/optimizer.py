...
from pysymex.core.solver.independence.cache import ConstraintIndependenceCacheMixin
from pysymex.core.solver.independence.lifecycle import ConstraintIndependenceLifecycleMixin
from pysymex.core.solver.independence.slicing import ConstraintIndependenceSlicingMixin
from pysymex.core.solver.independence.union_find import UnionFind


class ConstraintIndependenceOptimizer(
    ConstraintIndependenceLifecycleMixin,
    ConstraintIndependenceCacheMixin,
    ConstraintIndependenceSlicingMixin,
):
    ...
    def __init__(
        ...
        self._theory_signature_cache: dict[int, tuple[z3.ExprRef, tuple[str, ...]]] = {}
...
__all__ = ["ConstraintIndependenceOptimizer"]
