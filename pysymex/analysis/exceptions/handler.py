...
class ExceptionHandlerAnalyzer:
    ...
    def analyze_bytecode(self, code: Any) -> list[ExceptionHandlerInfo]:
    ...
    def _parse_exception_table(self, code: Any) -> list[ExceptionHandlerInfo]:
        ...
        try:
            ...
            {instr.offset: i for i, instr in enumerate(instructions)}
