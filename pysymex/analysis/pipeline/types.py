...
class AnalysisContext:
    ...
    types: dict[str, Any] = field(default_factory=dict[str, Any])

    patterns: Any = None

    ranges: dict[str, Any] = field(default_factory=dict[str, Any])

    taint: dict[str, set[TaintKind]] = field(default_factory=dict[str, set[TaintKind]])

    flow_analyzer: Any | None = None

    function_summaries: dict[str, Any] = field(default_factory=dict[str, Any])

    exception_handlers: list[Any] = field(default_factory=list[Any])

    none_check_analyzer: Any | None = None
