...
from pysymex.analysis.complexity import estimate_complexity
from pysymex.analysis.solver.analyzer import FunctionAnalyzer
from pysymex.analysis.solver.graph import CallGraph
...
class Z3Engine:
    ...
    def _verify_single_crash(self, crash: CrashCondition) -> VerificationResult:
        ...
        try:
            ...
            result_obj = solver.check(need_model=True)
            elapsed = (time.time() - start) * 1000
...
deserialize_worker_results = _deserialize_worker_results
