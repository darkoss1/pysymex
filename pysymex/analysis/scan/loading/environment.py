...
def get_default_module_globals() -> dict[str, object]:
    """Provide a default global namespace for compile-only target loading.

    Initializes the namespace with default builtins from :func:`~pysymex.core.builtins.get_all_builtins`,
    ...
    Limitations:
        ...
        :class:`~pysymex.core.types.containers.objects.SymbolicObject` instances.
    """
    ...
    for mod_name in common_modules:
        ...
        obj = SymbolicObject(mod_name, addr, get_int_val(addr), {addr})
