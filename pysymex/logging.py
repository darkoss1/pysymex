...
_logger: PysymexLogger | None = None


def get_logger() -> PysymexLogger:
    """Get the global logger instance."""
    global _logger
    if _logger is None:
        _logger = PysymexLogger()
    return _logger


def set_logger(logger: PysymexLogger) -> None:
...
def configure_logging(
    ...
    global _logger
    _logger = PysymexLogger(level=level, color=color, file_path=file_path)
    return _logger
