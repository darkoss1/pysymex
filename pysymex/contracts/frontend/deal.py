...
"""Source-only adapter for supported ``deal`` decorators."""
...
_DEAL_SPEC = LambdaDecoratorFrontendSpec(
    frontend=DEAL_FRONTEND,
    module_name="deal",
    kind_by_decorator={
...
def deal_clause_irs_from_source(
    source: str,
    *,
    module: str | None = None,
    filename: str = "<string>",
) -> tuple[ContractClauseIR, ...]:
    """Lower supported ``deal`` decorator clauses from source into IR."""
...
__all__ = ["DEAL_FRONTEND", "deal_clause_irs_from_source"]
