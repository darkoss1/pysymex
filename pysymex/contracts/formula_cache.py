...
Used by :class:`~pysymex.contracts.compiler.ContractCompiler` to reuse ``z3.BoolRef``
...
class FormulaCache:
    ...
    __slots__ = ("cache", "lock", "_max_size")
...
register_process_cache_clearer("contracts.formula_cache", formula_cache.clear)
