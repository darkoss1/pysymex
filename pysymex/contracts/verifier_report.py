...
:class:`~pysymex.contracts.verifier_report.VerificationReport` collects per-clause
results produced by :class:`~pysymex.contracts.verifier.ContractVerifier` (or compatible
...
from pysymex.contracts.types import Contract, ContractViolation, VerificationResult
