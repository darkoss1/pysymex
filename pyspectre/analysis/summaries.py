"""
Function Summaries for PySpectre.
...
class FunctionSummary:
    ...
    modified: list[ModifiedVariable] = field(default_factory=list)
    reads: list[ReadVariable] = field(default_factory=list)
    calls: list[CallSite] = field(default_factory=list)
    may_raise: list[ExceptionInfo] = field(default_factory=list)
    is_pure: bool = False
...
) -> tuple[z3.BoolRef, z3.BoolRef, z3.ExprRef]:
    """
