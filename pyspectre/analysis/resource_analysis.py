"""
Resource Leak and Memory Safety Analysis for PySpectre.
This module detects:
...
RESOURCE_OPENERS: dict[str, ResourceKind] = {
    ...
    "threading.Lock": ResourceKind.LOCK,
    "threading.RLock": ResourceKind.LOCK,
    "threading.Semaphore": ResourceKind.SEMAPHORE,
...
class ResourceLeakDetector:
    ...
    def detect(
        ...
        for i, instr in enumerate(instructions):
            ...
            elif opname in {"WITH_EXCEPT_START", "WITH_CLEANUP_START"}:
            ...
            if "parent" in self_attrs and "children" in self_attrs:
                warnings.append(
                    ResourceWarning(
                        ...
                        file=file_path,
                        line=self_attrs.get("parent", code.co_firstlineno),
