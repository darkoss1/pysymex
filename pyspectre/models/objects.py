"""Object-oriented modeling for PySpectre.
...
class SymbolicAttribute:
    ...
    def with_value(self, new_value: Any) -> SymbolicAttribute:
...
class SymbolicMethod:
    ...
    postconditions: list[z3.BoolRef] = field(default_factory=list)
...
class SymbolicClass:
    ...
    name: str
    bases: list[SymbolicClass] = field(default_factory=list)
    class_attrs: dict[str, SymbolicAttribute] = field(default_factory=dict)
    instance_attrs: dict[str, SymbolicAttribute] = field(default_factory=dict)
    methods: dict[str, SymbolicMethod] = field(default_factory=dict)
    is_abstract: bool = False
...
class SymbolicInstance:
    ...
    _z3_id: z3.IntRef | None = None

    @property
    def z3_id(self) -> z3.IntRef:
...
class TypeChecker:
    ...
    def type_of(self, value: Any) -> SymbolicClass | None:
...
class SymbolicDescriptor:
    ...
    def __get__(self, instance: SymbolicInstance | None, owner: SymbolicClass) -> Any:
        raise NotImplementedError

    def __set__(self, instance: SymbolicInstance, value: Any) -> None:
        raise NotImplementedError
