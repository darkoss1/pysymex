"""HTML report generation for PySpectre.
...
<head>
    ...
    <title>{title} - PySpectre Report</title>
    <style>
        :root {{
            --bg-primary: #1a1a2e;
            --bg-secondary: #16213e;
...
<body>
    <div class="container">
        ...
        <footer>
            Generated by PySpectre v{version} • 
            <a href="https://github.com/darkoss1/pyspecter" style="color: var(--accent);">GitHub</a>
        </footer>
    </div>
    <script>
