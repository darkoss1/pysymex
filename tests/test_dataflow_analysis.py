...
# ===========================================================================
# Tests for dataflow_core — analysis algorithms
# ===========================================================================
...
class TestReachingDefinitions:
    ...
    def test_simple_assignment(self):
        ...
        rd.analyze()
        # Should have collected definitions for x and y
    ...
    def test_overwritten_var(self):
        ...
        assert len(x_defs) >= 2  # both definitions recorded
...
class TestLiveVariables:
    ...
    def test_basic_liveness(self):
        ...
        lv.analyze()
        # LiveVariables is a backward analysis
    ...
    def test_dead_var_not_live(self):
        ...
        lv = LiveVariables(cfg)
        lv.analyze()
        # x is not live at any point after its definition since it's unused
        # y is also unused
...
class TestDefUseAnalysis:
    ...
    def test_simple_chain(self):
        ...
        # Should have chains for x and y
    ...
    def test_find_dead_stores(self):
        ...
        # The first assignment to x should be dead if it's never used before overwrite
        dead_vars = [d.var_name for d in dead]
        # x=1 might be detected as dead; y's final value isn't used either
    ...
    def test_multiple_uses(self):
        ...
        cfg, _ = _build_cfg("x = 1\ny = x\nz = x")
        du = DefUseAnalysis(cfg)
        # Find x's definition and check its chain
        x_defs = [d for d in du.chains if d.var_name == "x"]
        if x_defs:
            chain = du.chains[x_defs[0]]
            assert len(chain.uses) >= 1  # at least one use
...
class TestAvailableExpressions:
    ...
    def test_basic_analysis(self):
        ...
        ae.analyze()
        # Verify analysis ran; expressions set populated
...
class TestNullAnalysis:
    ...
    def test_none_assignment(self):
        ...
        na = NullAnalysis(cfg)
        na.analyze()
        # Check that analysis completes and produces facts for each block
        for block_id in cfg.blocks:
