...
class TestStateMerger:
    ...
    def test_get_signature(self) -> None:
        ...
        merger: pysymex.core.parallel.core.StateMerger[_DummyState] = pysymex.core.parallel.core.StateMerger()
    ...
    def test_should_merge(self) -> None:
        ...
        merger: pysymex.core.parallel.core.StateMerger[_DummyState] = pysymex.core.parallel.core.StateMerger(merge_threshold=1)
    ...
    def test_flush_pending(self) -> None:
        ...
        merger: pysymex.core.parallel.core.StateMerger[_DummyState] = pysymex.core.parallel.core.StateMerger(merge_threshold=2)
...
class TestParallelExplorer:
    ...
    def test_set_step_function(self) -> None:
        ...
        ex: pysymex.core.parallel.core.ParallelExplorer[_DummyState] = pysymex.core.parallel.core.ParallelExplorer()
    ...
    def test_set_check_function(self) -> None:
        ...
        ex: pysymex.core.parallel.core.ParallelExplorer[_DummyState] = pysymex.core.parallel.core.ParallelExplorer(step_function=_no_step)
