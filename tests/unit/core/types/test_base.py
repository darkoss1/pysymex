...
class TestTypeTag:
    """Test suite for pysymex._internal.core.types.base.TypeTag."""
...
class TestSymbolicType:
    """Test suite for pysymex._internal.core.types.base.SymbolicType."""
    ...
    def test_could_be_truthy(self) -> None:
        ...
        none_value = SymbolicNoneType()
        assert z3.eq(none_value.could_be_truthy(), none_value.is_truthy())

    def test_could_be_falsy(self) -> None:
        """Execution falsiness query matches the concrete none falsiness."""
        none_value = SymbolicNoneType()
        assert z3.eq(none_value.could_be_falsy(), none_value.is_falsy())

    def test_hash_value(self) -> None:
        """SymbolicType exposes content hashing for VMState deduplication."""
        assert SymbolicNoneType().hash_value() == SymbolicNoneType().hash_value()
    ...
    def test_is_int(self) -> None:
        ...
        assert z3.is_false(SymbolicNoneType().is_int)

    def test_is_bool(self) -> None:
        """Test is_bool behavior."""
        assert z3.is_false(SymbolicNoneType().is_bool)

    def test_is_float(self) -> None:
        """Test is_float behavior."""
        assert z3.is_false(SymbolicNoneType().is_float)

    def test_is_str(self) -> None:
        """Test is_str behavior."""
        assert z3.is_false(SymbolicNoneType().is_str)

    def test_is_none(self) -> None:
        """Test is_none behavior."""
        assert z3.is_true(SymbolicNoneType().is_none)

    def test_is_path(self) -> None:
        """Test is_path behavior."""
        assert z3.is_false(SymbolicNoneType().is_path)

    def test_is_obj(self) -> None:
        """Test is_obj behavior."""
        assert z3.is_false(SymbolicNoneType().is_obj)

    def test_is_list(self) -> None:
        """Test is_list behavior."""
        assert z3.is_false(SymbolicNoneType().is_list)

    def test_is_dict(self) -> None:
        """Test is_dict behavior."""
        assert z3.is_false(SymbolicNoneType().is_dict)


class TestSymbolicNoneType:
    """Test suite for pysymex._internal.core.types.base.SymbolicNoneType."""
