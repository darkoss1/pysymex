import pytest
from pysymex.analysis.patterns.formal import (
...
class TestFunctionChecklistItem:
    """Test suite for pysymex.analysis.patterns.formal.FunctionChecklistItem."""
...
class TestDifferentialResult:
    """Test suite for pysymex.analysis.patterns.formal.DifferentialResult."""
...
class TestMutationResult:
    """Test suite for pysymex.analysis.patterns.formal.MutationResult."""
