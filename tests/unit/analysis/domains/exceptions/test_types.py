...
class TestExceptionWarningKind:
    """Test suite for pysymex.analysis.domains.exceptions.types.ExceptionWarningKind."""
...
class TestHandlerIntent:
    """Test suite for pysymex.analysis.domains.exceptions.types.HandlerIntent."""
...
class TestExceptionWarning:
    """Test suite for pysymex.analysis.domains.exceptions.types.ExceptionWarning."""
...
class TestExceptionHandler:
    """Test suite for pysymex.analysis.domains.exceptions.types.ExceptionHandler."""
...
class TestTryBlock:
    """Test suite for pysymex.analysis.domains.exceptions.types.TryBlock."""
