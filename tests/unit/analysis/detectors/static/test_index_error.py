...
"""Tests for pysymex/analysis/detectors/static/index_error.py."""

from unittest.mock import Mock, patch
import z3
import dis
import pytest
from pysymex.analysis.detectors.static.index_error import StaticIndexErrorDetector
...
class TestStaticIndexErrorDetector:
    ...
    def test_issue_kind(self) -> None:
        ...
        assert StaticIndexErrorDetector().issue_kind().name == "INDEX_ERROR"
