...
class TestDeadCodeKind:
    """Test suite for pysymex.analysis.static.dead_code.types.DeadCodeKind."""
...
class TestDeadCode:
    """Test suite for pysymex.analysis.static.dead_code.types.DeadCode."""
    ...
    def test_format(self) -> None:
        ...
        dc2 = DeadCode(kind=DeadCodeKind.DEAD_STORE, file="test.py", line=5, message="msg")
