from pysymex.analysis.static.stubs.types import StubType, FunctionStub, ClassStub, ModuleStub


class TestStubType:
    """Test suite for pysymex.analysis.static.stubs.types.StubType."""
...
class TestFunctionStub:
    """Test suite for pysymex.analysis.static.stubs.types.FunctionStub."""
...
class TestClassStub:
    """Test suite for pysymex.analysis.static.stubs.types.ClassStub."""
...
class TestModuleStub:
    """Test suite for pysymex.analysis.static.stubs.types.ModuleStub."""
