...
class TestEffect:
    """Test suite for pysymex.analysis.static.cross_function.types.Effect."""
...
class TestEffectSummary:
    """Test suite for pysymex.analysis.static.cross_function.types.EffectSummary."""
...
class TestCallSiteInfo:
    """Test suite for pysymex.analysis.static.cross_function.types.CallSiteInfo."""
...
class TestCallGraphNode:
    """Test suite for pysymex.analysis.static.cross_function.types.CallGraphNode."""
...
class TestCallContext:
    """Test suite for pysymex.analysis.static.cross_function.types.CallContext."""
...
class TestContextSensitiveSummary:
    """Test suite for pysymex.analysis.static.cross_function.types.ContextSensitiveSummary."""
