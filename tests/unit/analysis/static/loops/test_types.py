...
class TestLoopType:
    """Test suite for pysymex.analysis.static.loops.types.LoopType."""
...
class TestLoopBound:
    """Test suite for pysymex.analysis.static.loops.types.LoopBound."""
...
class TestLoopInfo:
    """Test suite for pysymex.analysis.static.loops.types.LoopInfo."""
...
class TestInductionVariable:
    """Test suite for pysymex.analysis.static.loops.types.InductionVariable."""
...
class TestLoopSummary:
    """Test suite for pysymex.analysis.static.loops.types.LoopSummary."""
