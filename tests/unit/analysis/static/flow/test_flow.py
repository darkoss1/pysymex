...
from pysymex.analysis.static.dataflow.types import Definition, NullInfo, NullState
...
class TestFlowSensitiveAnalyzer:
    """Test suite for pysymex.analysis.static.flow.FlowSensitiveAnalyzer."""

    @patch("pysymex.analysis.static.flow.analyzer.CFGBuilder")
    ...
    @patch("pysymex.analysis.static.flow.analyzer.CFGBuilder")
    def test_is_variable_live(self, mock_cfg_builder: Mock) -> None:
    ...
    @patch("pysymex.analysis.static.flow.analyzer.CFGBuilder")
    def test_is_dead_store(self, mock_cfg_builder: Mock) -> None:
    ...
    @patch("pysymex.analysis.static.flow.analyzer.CFGBuilder")
    def test_may_be_null(self, mock_cfg_builder: Mock) -> None:
    ...
    @patch("pysymex.analysis.static.flow.analyzer.CFGBuilder")
    def test_is_in_loop(self, mock_cfg_builder: Mock) -> None:
    ...
    @patch("pysymex.analysis.static.flow.analyzer.CFGBuilder")
    def test_get_loop_header(self, mock_cfg_builder: Mock) -> None:
    ...
    @patch("pysymex.analysis.static.flow.analyzer.CFGBuilder")
    def test_get_dominator(self, mock_cfg_builder: Mock) -> None:
    ...
    @patch("pysymex.analysis.static.flow.analyzer.CFGBuilder")
    def test_is_reachable(self, mock_cfg_builder: Mock) -> None:
...
class TestFlowContext:
    """Test suite for pysymex.analysis.static.flow.FlowContext."""
