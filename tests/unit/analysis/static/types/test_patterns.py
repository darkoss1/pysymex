...
from pysymex.analysis.static.types.patterns import PatternRecognizer, TypeState, TypeStateMachine


class TestPatternRecognizer:
    """Test suite for pysymex.analysis.static.types.patterns.PatternRecognizer."""
...
class TestTypeState:
    """Test suite for pysymex.analysis.static.types.patterns.TypeState."""
...
class TestTypeStateMachine:
    """Test suite for pysymex.analysis.static.types.patterns.TypeStateMachine."""
