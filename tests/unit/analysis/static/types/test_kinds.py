from pysymex.analysis.static.types.kinds import TypeKind, PyType


class TestTypeKind:
    """Test suite for pysymex.analysis.static.types.kinds.TypeKind."""

    def test_enum_members(self) -> None:
        """TypeKind owns categories only; PyType owns type construction."""
        assert TypeKind.INT.name == "INT"
        assert TypeKind.STR.name == "STR"
        assert TypeKind.NONE.name == "NONE"


class TestPyType:
    """Test suite for pysymex.analysis.static.types.kinds.PyType."""
    ...
    def test_is_numeric(self) -> None:
        ...
        assert PyType.bool_().is_numeric() is True
