...
from pysymex.analysis.specialized.assertions import (
    ContextType, AssertionAnalysis, analyze_function_name,
    analyze_source_context, analyze_assertion, is_intentional_assertion
)
...
def test_analyze_assertion() -> None:
    ...
    # Will probably be unknown and not intentional
