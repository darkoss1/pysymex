...
from pysymex.models.containers.dicts.mutations.pop import DictPopitemModel
...
def test_dict_popitem_does_not_mutate_receiver_in_place() -> None:
    ...
    assert z3.is_true(z3.simplify(source.z3_len == 1))
    ...
    assert z3.is_true(z3.simplify(updated.z3_len == old_len - 1))
