"""Tests for pysymex._internal.models.stdlib.functools — all model functions + classes."""
...
class TestPartialModel:
    ...
    def test_model_partial_returns_partial_model(self) -> None:
        ...
        from pysymex._internal.models.stdlib.functools.core import PartialModel, model_partial
    ...
    def test_partial_call_returns_symbolic_value(self) -> None:
        ...
        from pysymex._internal.models.stdlib.functools.core import model_partial
...
class TestModelReduce:
    ...
    def test_reduce_returns_symbolic(self) -> None:
        ...
        from pysymex._internal.core.types.scalars.values import SymbolicValue
        from pysymex._internal.models.stdlib.functools.core import model_reduce
...
class TestLRUCacheModel:
    ...
    def test_model_lru_cache_returns_model(self) -> None:
        ...
        from pysymex._internal.models.stdlib.functools.cache import LRUCacheModel, model_lru_cache
    ...
    def test_wrapped_function_returns_symbolic(self) -> None:
        ...
        from pysymex._internal.core.types.scalars.values import SymbolicValue
        from pysymex._internal.models.stdlib.functools.cache import LRUCacheModel
...
class TestCachedPropertyModel:
    ...
    def test_get_with_none_returns_descriptor(self) -> None:
        ...
        from pysymex._internal.models.stdlib.functools.cache import CachedPropertyModel
...
class TestModelWraps:
    ...
    def test_wraps_preserves_name(self) -> None:
        ...
        from pysymex._internal.models.stdlib.functools.core import model_wraps
...
class TestModelTotalOrdering:
    ...
    def test_returns_class_unchanged(self) -> None:
        ...
        from pysymex._internal.models.stdlib.functools.core import model_total_ordering
...
class TestModelSingledispatch:
    ...
    def test_returns_function_unchanged(self) -> None:
        ...
        from pysymex._internal.models.stdlib.functools.core import model_singledispatch
