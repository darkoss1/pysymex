...
from pysymex._internal.execution.model.effects.core import (
    issues_from_model_side_effects as issues_from_model_side_effects_owner,
)


def test_model_effects_public_export_points_to_direct_owner() -> None:
    assert issues_from_model_side_effects is issues_from_model_side_effects_owner
