...
class TestSubstituteAbstractNames:
    """Test the substitute_abstract_names / _replace inner function."""
    ...
    def test_no_replacement_for_unknown_names(self) -> None:
        ...
        result = serializer.substitute_abstract_names("(+ k!99 k!100)")
    ...
    def test_replacement_via_override(self) -> None:
        ...
        serializer = Z3Serializer(registry)
        result = serializer.substitute_abstract_names("(+ k!0 k!1)")
        assert "x" in result
        assert "y" in result
    ...
    def test_replacement_of_bare_exclamation_pattern(self) -> None:
        ...
        serializer = Z3Serializer(registry)
        result = serializer.substitute_abstract_names("(bvadd !0 k!0)")
    ...
    def test_partial_match_does_not_replace(self) -> None:
        ...
        result = serializer.substitute_abstract_names("(+ k!0 normal_var)")
