...
class TestBenchmarkInfrastructure:
    ...
    def test_benchmark_result_dataclass(self):
        from pysymex.benchmarks.suite import BenchmarkResult, BenchmarkCategory
    ...
    def test_benchmark_reporter_markdown(self):
        from pysymex.benchmarks.suite import BenchmarkReporter, BenchmarkResult, BenchmarkCategory
...
class TestConstraintSimplification:
    ...
    def test_simplifier_basic(self):
        ...
        result = simplify_constraints([x > 0, x > 0])
