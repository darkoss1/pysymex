...
class TestRaisesDecorator:
    ...
    def test_raises_decorator(self):
        ...
        assert len(sqrt.__raises__) == 1

        assert sqrt.__raises__[0].exc_type is ValueError

        assert sqrt.__raises__[0].condition == "x < 0"
