...
from pysymex.analysis.function_models import BuiltinModels, MethodModels
...
def get_concrete(value):
    ...
    # Handle concrete Python values directly
    ...
    if isinstance(value, SymbolicValue):
        ...
        if hasattr(value, "concrete"):
            return value.concrete  # type: ignore[reportAttributeAccessIssue]
        elif hasattr(value, "value"):
            v = value.value  # type: ignore[reportAttributeAccessIssue]
    ...
    # Check for to_concrete method
    if hasattr(value, "to_concrete"):
        return value.to_concrete()  # type: ignore[reportAttributeAccessIssue]

    # Check for concrete_value property
    if hasattr(value, "concrete_value"):
        return value.concrete_value  # type: ignore[reportAttributeAccessIssue]
...
class TestModelRegistry:
    ...
    def test_analysis_exports_resolve(self):
        """Lazy exports from analysis.function_models should resolve."""
        assert BuiltinModels.get("len") is not None
        assert MethodModels.get(TypeKind.LIST, "append") is not None
    ...
    def test_registry_model_count(self):
        ...
        models = default_model_registry.list_models()
        assert len(models) >= 35  # We added many new models


# =============================================================================
# Type Conversion Model Tests
# =============================================================================
...
class TestIntModel:
    ...
    def test_int_from_concrete(self):
        ...
        result = model.apply([42], {}, state)  # type: ignore[reportArgumentType]
    ...
    def test_int_from_float_concrete(self):
        ...
        result = model.apply([3.7], {}, state)  # type: ignore[reportArgumentType]
    ...
    def test_int_from_string(self):
        ...
        result = model.apply(["123"], {}, state)  # type: ignore[reportArgumentType]
...
class TestFloatModel:
    ...
    def test_float_default(self):
        ...
        result = model.apply([], {}, state)  # type: ignore[reportArgumentType]
...
class TestBoolModel:
    ...
    def test_bool_from_zero(self):
        ...
        result = model.apply([0], {}, state)  # type: ignore[reportArgumentType]
...
class TestStrModel:
    ...
    def test_str_from_int(self):
        ...
        result = model.apply([42], {}, state)  # type: ignore[reportArgumentType]
        # Should be a SymbolicString or string
...
class TestListModel:
    ...
    def test_list_empty(self):
        ...
        result = model.apply([], {}, state)  # type: ignore[reportArgumentType]
        # Should be SymbolicList or list
        assert result.value is not None
    ...
    def test_list_from_tuple(self):
        ...
        result = model.apply([(1, 2, 3)], {}, state)  # type: ignore[reportArgumentType]
        # Should be SymbolicList or list
        assert result.value is not None
...
class TestAbsModel:
    ...
    def test_abs_positive(self):
        ...
        result = model.apply([5], {}, state)  # type: ignore[reportArgumentType]
    ...
    def test_abs_symbolic(self):
        ...
        result = model.apply([x], {}, state)  # type: ignore[reportArgumentType]

        # Result should have constraints
        assert len(result.constraints) > 0  # type: ignore[reportArgumentType]
...
class TestMinModel:
    ...
    def test_min_two_args(self):
        ...
        result = model.apply([5, 3], {}, state)  # type: ignore[reportArgumentType]
        assert get_concrete(result.value) == 3
    ...
    def test_min_list(self):
        ...
        result = model.apply([[5, 3, 7]], {}, state)  # type: ignore[reportArgumentType]
        assert get_concrete(result.value) == 3
...
class TestSumModel:
    ...
    def test_sum_with_start(self):
        ...
        result = model.apply([[1, 2, 3], 10], {}, state)  # type: ignore[reportArgumentType]
...
class TestPowModel:
    ...
    def test_pow_concrete(self):
        ...
        result = model.apply([2, 3], {}, state)  # type: ignore[reportArgumentType]
    ...
    def test_pow_with_mod(self):
        ...
        result = model.apply([2, 10, 100], {}, state)  # type: ignore[reportArgumentType]
        assert get_concrete(result.value) == 24  # 2^10 % 100
...
class TestRoundModel:
    ...
    def test_round_with_digits(self):
        ...
        result = model.apply([3.14159, 2], {}, state)  # type: ignore[reportArgumentType]
        concrete = get_concrete(result.value)
        assert abs(float(concrete) - 3.14) < 0.01  # type: ignore[reportArgumentType]
...
class TestDivmodModel:
    ...
    def test_divmod_integers(self):
        ...
        result = model.apply([17, 5], {}, state)  # type: ignore[reportArgumentType]
        q, r = result.value
...
class TestAllModel:
    ...
    def test_all_true(self):
        ...
        result = model.apply([[True, True, True]], {}, state)  # type: ignore[reportArgumentType]
        assert get_concrete(result.value) == True
    ...
    def test_all_false(self):
        ...
        result = model.apply([[True, False, True]], {}, state)  # type: ignore[reportArgumentType]
        assert get_concrete(result.value) == False
...
class TestAnyModel:
    ...
    def test_any_one_true(self):
        ...
        result = model.apply([[False, True, False]], {}, state)  # type: ignore[reportArgumentType]
        assert get_concrete(result.value) == True
    ...
    def test_any_all_false(self):
        ...
        result = model.apply([[False, False]], {}, state)  # type: ignore[reportArgumentType]
        assert get_concrete(result.value) == False
...
class TestOrdModel:
    ...
    def test_ord_char(self):
        ...
        result = model.apply(["A"], {}, state)  # type: ignore[reportArgumentType]
...
class TestChrModel:
    ...
    def test_chr_int(self):
        ...
        result = model.apply([65], {}, state)  # type: ignore[reportArgumentType]
        assert result.value is not None  # SymbolicString or str
...
class TestReprModel:
    ...
    def test_repr_string(self):
        ...
        result = model.apply(["hello"], {}, state)  # type: ignore[reportArgumentType]
        assert result.value is not None  # SymbolicString
...
class TestHasattrModel:
    ...
    def test_hasattr_exists(self):
        ...
        result = model.apply([[1, 2], "append"], {}, state)  # type: ignore[reportArgumentType]
        assert get_concrete(result.value) == True
    ...
    def test_hasattr_missing(self):
        ...
        result = model.apply([42, "append"], {}, state)  # type: ignore[reportArgumentType]
        assert get_concrete(result.value) == False
...
class TestGetattrModel:
    ...
    def test_getattr_exists(self):
        ...
        result = model.apply([[1, 2], "__len__"], {}, state)  # type: ignore[reportArgumentType]
        # Should return the attribute (a method)
...
class TestIdModel:
    ...
    def test_id_returns_int(self):
        ...
        result = model.apply([42], {}, state)  # type: ignore[reportArgumentType]
        # Result should have is_int constraint
        assert any("is_int" in str(c) or "Int" in str(c) for c in result.constraints)  # type: ignore[reportOptionalIterable]
...
class TestInputModel:
    ...
    def test_input_returns_string(self):
        ...
        result = model.apply(["prompt: "], {}, state)  # type: ignore[reportArgumentType]
        # Should return SymbolicString or similar
        assert result.value is not None
        assert result.side_effects.get("io") == True  # type: ignore[reportOptionalMemberAccess]
...
class TestModelEffectIntegration:
    ...
    def test_model_constraints_valid(self):
        ...
        for c in result.constraints:  # type: ignore[reportOptionalIterable]
